...
class R2Plus1DNet(nn.Module):
    ...
    def __init__(self, layer_sizes, block_type=SpatioTemporalResBlock):
        ...
        self.conv1_1 = SpatioTemporalConv(3, 64, (1, 3, 3), stride=(1, 1, 1), padding=(0, 1, 1), first_conv=True)
        self.conv1_2 = SpatioTemporalConv(64, 64, (1, 3, 3), stride=(1, 1, 1), padding=(0, 1, 1))
...
def R2Plus1D19(**kwargs):
    """Construct a P3D64 modelbased on a ResNet-19-3D model.
    """
    model = R2Plus1DNet([2, 2, 2, 2], **kwargs)
    return model


def R2Plus1D64(**kwargs):
    """Construct a P3D64 modelbased on a ResNet-50-3D model.
    """
    model = R2Plus1DNet([3, 4, 6, 3], **kwargs)
    return model

def R2Plus1D131(**kwargs):
    """Construct a P3D131 model based on a ResNet-101-3D model.
    """
    model = R2Plus1DNet([3, 4, 23, 3], **kwargs)
    return model
